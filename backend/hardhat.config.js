...
module.exports = {
  ...
  solidity: {
    ...
    settings: {
      optimizer: {
        enabled: true,
        runs: 200 // Un nombre bas de "runs" est généralement meilleur pour les contrats qui seront déployés, alors qu'un nombre élevé est meilleur pour les contrats exécutés fréquemment.
      }
    }
  }
};
